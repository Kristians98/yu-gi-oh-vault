...
// cards where they changed. Existing printings and their prices are left alone — the
// price cron owns those. Safe to run on an empty DB (that is how the seed imports).
